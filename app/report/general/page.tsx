...
export default function GeneralReportPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const selectedEp = episodes.find(ep => ep.id.toString() === selectedEpisode);
    ...
    try {
      const response = await fetch('/api/report-problem', {
        ...
        body: JSON.stringify({
          episodeId: selectedEp ? selectedEp.id : 'N/A',
          episodeName: selectedEp ? selectedEp.name : 'General Site Issue',
          episodeCode: selectedEp ? selectedEp.episode : 'N/A',
          problemType,
          description,
        }),
      });
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-zinc-900/80 backdrop-blur-md rounded-xl p-8 border border-zinc-800">
          ...
          <p className="text-gray-400 mb-6">
            General site issue or feedback
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              >
                ...
                <option value="mobile_issue">Mobile/responsive issue</option>
            ...
            <div>
              ...
              >
                <option value="">No specific episode</option>
                {episodes.map(ep => (
              ...
              <p className="text-sm text-gray-500 mt-2">
                Select an episode if this issue is specific to one
              </p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Please describe the problem or suggestion in detail..."
                rows={5}
