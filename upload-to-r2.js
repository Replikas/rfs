...
// Episode mapping: episode number to season/episode
const episodeMap = {
...
async function uploadBatch() {
  ...
  console.log('1. Point to your main folder (can have subfolders!)');
  console.log('2. Script will search ALL subfolders automatically');
  console.log('3. Files must have S##E## in name (e.g., "S01E01.mp4", "Rick and Morty S02E05.mp4")');
  console.log('4. Enter the folder path below\n');
  ...
  readline.question('Enter the folder path with your videos: ', async (folderPath) => {
    readline.close();
    ...
    // Recursively find all MP4 files in folder and subfolders
    ...
    const filePaths = findAllMP4s(folderPath);
    ...
    console.log(`\n⚠️  Ready to upload ${matches.length} episodes to R2.`);
    console.log('This will REPLACE the corrupted versions.\n');
    ...
    rl2.question('Continue? (yes/no): ', async (answer) => {
      rl2.close();
